...
#' @export
rmf_convert_real_to_dis <- function(x,y,prj,z=NULL,dis=NULL)
{
   x <- x-prj$origin[1]
   y <- y-prj$origin[2]
...
#' @describeIn rmf_ Deprecated function name
#' @export
convert_real_to_dis <- function(...) {
   .Deprecated(new = "rmf_convert_real_to_dis", old = "convert_real_to_dis")
   rmf_convert_real_to_dis(...)
}
